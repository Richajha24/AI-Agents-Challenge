"""Reusable Groq API client for resume and job matching analysis."""
...
class GroqClient:
    ...
    def analyze_candidate(
        self, evaluation_context: str, system_prompt: str | None = None
    ) -> str:
        """Send resume and job description context to Groq and return the hiring report."""
        ...
        try:
            ...
            raise GroqClientError(
                "Could not connect to Groq API. Check your network connection."
            ) from exc
        except APIStatusError as exc:
            raise GroqClientError(f"Groq API error: {exc.message}") from exc
