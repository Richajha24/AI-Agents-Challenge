"""Reusable Groq API client for code review."""
...
class GroqClient:
    ...
    def review_code(self, code_context: str, system_prompt: str | None = None) -> str:
        """Send source code context to Groq and return the structured review."""
