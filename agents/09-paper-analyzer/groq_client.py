"""Reusable Groq API client for research paper analysis."""
...
class GroqClient:
    ...
    def analyze_paper(self, paper_context: str, system_prompt: str | None = None) -> str:
        """Send paper context to Groq and return the structured analysis."""
        ...
        try:
            ...
            # exc may not have .message across versions; coerce to str
            raise GroqClientError(f"Groq API error: {getattr(exc, 'message', None) or str(exc)}") from exc
