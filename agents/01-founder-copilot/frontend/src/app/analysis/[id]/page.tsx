  ...
  return (
    <div className="min-h-screen bg-warm-ivory">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold mb-2">Analyzing Your Startup</h1>
        <p className="text-dark-graphite opacity-70 mb-12">
          Our AI agents are working on your analysis. This typically takes 2-3 minutes.
        </p>
        ...
        <div className="mt-12 text-center">
          <p className="text-dark-graphite opacity-70">
            ✨ You'll be redirected to your report when analysis is complete
          </p>
        </div>
      </div>
    </div>
