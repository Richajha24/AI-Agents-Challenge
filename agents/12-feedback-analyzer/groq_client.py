"""Reusable Groq API client for feedback analysis."""
...
class GroqClient:
    ...
    def analyze_feedback(self, feedback_context: str, system_prompt: str | None = None) -> str:
        """Send feedback context to Groq and return the structured analysis (markdown)."""
