"""Reusable Groq API client for documentation generation."""
...
class GroqClient:
    ...
    def generate_documentation(
        self, project_description: str, system_prompt: str | None = None
    ) -> str:
        """Send a project description to Groq and return structured documentation."""
